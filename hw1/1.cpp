...
const int nval=5;
double func[nval][2]={{0.2, 0.0015681},{0.3,0.0077382},{0.4,0.023579},{0.5,0.054849},{0.6,0.10696}};
...
//Calling the value() function and outputting the result
	...
	cout<<"The numerical uncertainty for 0.16 is: "<<0.5*(abs(C[4][0])+abs(D[4][0]))<<'\n';
	cout<<"The function's value at 0.46 is "<<value(0.46)<<'\n';
	cout<<"The numerical uncertainty for 0.46 is: "<<0.5*(abs(C[4][0])+abs(D[4][0]))<<'\n';
