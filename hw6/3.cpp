...
string file1 ="phi_0.045.dat";
string file2 ="phia_0.045.dat";
...
int main()
{
	...
	{
		//explicit scheme for calculating elements of b
		for(int i=1;i<ni+1;i++)
		{
			b(i)=phi(i,j-1)+(dt/(dx*dx))*(phi(i+1,j-1)+phi(i-1,j-1)-2*phi(i,j-1));
		}
		//cout<<b<<'\n';
